...
from src.ui.game_sidebar import GameSidebar
...
class GameScene(Scene):
    ...
    def enter(self):
        ...
        # Initialize the wave manager but don't start waves automatically
        self.wave_manager.start()
        # Reset wave counter to 0 (no waves started yet)
    ...
    def handle_event(self, event):
        ...
        """
        # Let the sidebar handle events first
